...
const Section2 = () => {	
  const [ref, inView, entry] = useInView({
	...
	return (
      ...
      <svg className="section2__wave" 
      xmlns="http://www.w3.org/2000/svg"
      data-name="Layer 1"
      viewBox="0 0 2753 177" width="2753" height="177"
    >
      <motion.path ref={ref} animate={inView && "forwards" } initial={"backwards"} transition={{ ease: "linear", duration: 5}}  variants={wave}
        fill="#19224F"
      ...
      />
			...
			<motion.svg className="section2__illustration coffee-particles" ref={ref} animate={ inView && "play" } initial={"pause"} variants={fadeIn} transition={{duration: 5}} xmlns="http://www.w3.org/2000/svg" width="124" height="346" viewBox="0 0 124 346">
		  <motion.g className="cofeee-particles__bits" fill="#19224F" fill-rule="evenodd">
			...
			<motion.div ref={ref} className="section2__text" transition={{duration: 5}}
      variants={fadeIn} animate={"play"} initial={"pause"}>
