...
const Section1 = () => {
	...
	return (
		<section className="c-section1 c-section1--drip t-deepBlue">
			...
			<motion.svg className="" ref={ref} animate={inView && "play" } initial={"pause"} transition={{ ease: "easeOut", duration: 8}} variants={variants} width="56" height="273" viewBox="0 0 56 273" xmlns="http://www.w3.org/2000/svg"><g fill="#FFF" fillRule="evenodd"><path className="c-section__animDrip" d="M0 0h19v263.5a9.5 9.5 0 0 1-19 0V0z"/><path className="c-section__animDrip" d="M37 0h19v124.5a9.5 9.5 0 0 1-19 0V0z"/></g></motion.svg>
	  </section>
	)
}
